...
<div class="pure-g">
    <div class="pure-u-1 r_1">
        <div class="wrapper">
            <h2 style="font-size: 80px">佛山公司注册仅需三大步骤</h2>
            <p style="margin-top:42px">
            </p><ul class="r_1_list">
                <li>
                    <dl>
                        <dt><img src="./foshan/user.png" width="156" height="146" alt=""></dt>
                        <dd ><p style="font-size: 20px">核名设立</p> </dd>
                    </dl>
                </li>
                <li class="icon_next"><img src="./foshan/arrow_1.png" width="36" height="66" alt=""></li>
                <li>
                    <dl>
                        <dt><img src="./foshan/user.png" width="156" height="146" alt=""></dt>
                        <dd><p style="font-size: 20px">提交材料</p></dd>
                    </dl>
                </li>
                <li class="icon_next"><img src="./foshan/arrow_1.png" width="36" height="66" alt=""></li>
                <li>
                    <dl>
                        <dt><img src="./foshan/user.png" width="156" height="146" alt=""></dt>
                        <dd><p style="font-size: 20px">领取营业执照</p></dd>
                    </dl>
                </li>
            </ul>
            <div class="clear"></div>
            <p></p>
            <p style="margin-top:44px; font-size:40px;">高级顾问为您把关，用户持续增长中...</p>
            <p style="margin-top:14px; font-size:72px;">所以选择很重要</p>
            <p style="margin-top:18px; font-size:50px;">￥<span style="color:#f02e2e; font-size:50px; font-weight:bold">&nbsp;0.00</span>元佛山代理注册公司费用</p>
{{--            <p style="color:#8e8e8e; text-decoration:line-through; font-size:50px; margin-top:14px">找其他佛山代办注册公司：￥500-1500元</p>--}}
...
{{--    </div>--}}
    <div class="pure-u-1 r_3">
        <div class="wrapper">
            <h2 style="font-size: 80px">佛山公司注册 真正极简 快捷流程</h2>
            <p style="margin-top:12px; font-size:50px; color:#909090">综合化管理 只需三步 完成佛山公司注册</p>
            <p style="margin-top:70px;"><img src="./foshan/three_image.png" width="100%" height="290px" alt=""></p>
            <ul class="step_line">
                <li class="step">
                    <div class="setp_text">
                        <p>1-2工作日</p>
...
{{--        <div class="wrapper">--}}
{{--            <h2>选择我们 一劳永逸</h2>--}}
{{--            <p style="margin-top:12px; font-size:48px; color:#909090">省钱/省心/省时/省事</p>--}}
{{--        </div>--}}
...
{{--    </div>--}}
    <div class="pure-u-1 r_5" style="padding:96px 0px">
        <p><img src="./foshan/call_phone.png" width="915" height="162" alt=""></p>
        <div style="text-align: center; width: 1000px; margin: auto;">
            <p style="width: 48%;line-height: 35px; float: left; margin-top:17px; background:url(./foshan/phone_background_white.png) center center no-repeat; background-size:100% auto; height:35px;padding:25px 0px;color:#1d65d4; font-size:50px; font-weight:bold;">
                400-850-0074
            </p>
            <p class="go_btn" style="float: right; margin-top:31px; width: 48%;">
                <a href="javascript:void(0);" onclick="open_chat()">点我立即咨询</a>
