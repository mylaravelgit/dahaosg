...
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=GBK">
    ...
    <title>10年专注公司注册</title>

    <title>大好时光（广东）企业管理有限公司,广东公司注册,广东代理注册公司</title>

    <meta name="keywords" content="广东公司注册,广东注册公司,广东工商注册">
    <meta name="description" content="广东代理注册公司需要多少钱，如何注册广东公司？0元代办广东公司注册，免广东工商注册代理费、广东工商注册公司工本费，提供广东公司注册地址，大好时光免费代办广东注册公司。">
...
{{--            <div class="logo"><a href="/"><img src="./foshan/logo.png" style="width: 120%;height: 120%" alt="大好时光（广东）企业管理有限公司"></a></div>--}}
{{--            <div class="iphone">--}}
...
{{--        <div class="wire"></div>--}}
    ...
    <h1 style="font-size: 50px">10年专注公司注册</h1>
    <p style="margin-top:50px; font-size:40px; text-align:center">省心/省钱的全程服务</p>
    <h1 style="font-size: 50px">提供广东公司注册地址</h1>
...
<div class="pure-g">
    ...
    <div class="pure-u-1 r_1">
        <div class="wrapper">
            ...
            <p style="margin-top:42px">
                ...
                <li>
                    <dl>
                        <dt><img src="./foshan/user.png" width="78" height="73" alt=""></dt>
                        <dd>核名设立</dd>
                    </dl>
                </li>
                <li class="icon_next"><img src="./foshan/arrow_1.png" width="18" height="33" alt=""></li>
                <li>
                    <dl>
                        <dt><img src="./foshan/user.png" width="78" height="73" alt=""></dt>
                        <dd>提交材料</dd>
            ...
            <div class="clear"></div>
            <p></p>
            <p style="margin-top:44px; font-size:18px;">高级顾问为您把关，用户持续增长中...</p>
            <p style="margin-top:14px; font-size:36px;">所以选择很重要</p>
            <p style="margin-top:18px; font-size:30px;">￥<span style="color:#f02e2e; font-size:36px; font-weight:bold">&nbsp;0.00</span>元广东代理注册公司费用</p>
            <p style="color:#8e8e8e; text-decoration:line-through; font-size:18px; margin-top:14px">找其他广东代办注册公司：￥500-1500元</p>
            <p style="margin-top:24px; font-size:14px; line-height:20px">免费广东公司注册代理热线</p>
            <p style="margin-top:16px; background:url(./foshan/phone_bakground_blue.png) center center no-repeat; height:30px;padding:11px 0px;color:#fff; font-size:27px; font-weight:bold;">400-850-0074</p>
            <p style="margin-top:22px; font-size:12px;">专业客服高响应机制随时为您服务</p>
            <p class="go_btn" style="margin-top:10px;">
                <a href="javascript:void(0);" onclick="open_chat()"style="">点我立即咨询</a>
            </p>
            <div style="background:url(./foshan/arrow.png) no-repeat; width:74px; height:57px; position:relative; top:-60px; left:720px;"></div>
        </div>
    </div>
    <div class="pure-u-1 r_2">
        <div class="wrapper">
            <h2>电话免费咨询广东工商注册公司方案</h2>
            <table>
                <tbody><tr>
                    <td valign="middle" class="th1 th">服务项目</td>
                    <td valign="middle" class="th2 th">广东公司注册前</td>
                    <td valign="middle" class="th3 th">广东注册公司后</td>
                </tr>
                <tr>
                    <td valign="middle" class="td1">项目一</td>
                    <td valign="middle" class="td2"><img src="./foshan/point.png" width="20" height="21" alt="" style="margin-bottom:4px;margin-right:10px;vertical-align:middle">注册广东公司名称起什么样的结构？</td>
                    <td valign="middle" class="td2"><img src="./foshan/point.png" width="20" height="21" alt="" style="margin-bottom:4px;margin-right:10px;vertical-align:middle">广东公司代理记账怎么做？</td>
                </tr>
                <tr>
                    <td valign="middle" class="td1">项目二</td>
                    <td valign="middle" class="td2"><img src="./foshan/point.png" width="20" height="21" alt="" style="margin-bottom:4px;margin-right:10px;vertical-align:middle">广东公司注册地址该怎么选择？</td>
                    <td valign="middle" class="td2"><img src="./foshan/point.png" width="20" height="21" alt="" style="margin-bottom:4px;margin-right:10px;vertical-align:middle">广东公司报税怎么做？</td>
                </tr>
                <tr>
                    <td valign="middle" class="td1">项目三</td>
                    <td valign="middle" class="td2"><img src="./foshan/point.png" width="20" height="21" alt="" style="margin-bottom:4px;margin-right:10px;vertical-align:middle">广东公司注册需要多长时间？</td>
            ...
            <p style="margin-top:48px; font-size:28px; font-weight:normal">免费咨询电话 </p>
            <div style="text-align: center; width: 400px; margin: auto;">
                <p style="width: 48%;line-height: 35px; float: left; margin-top:17px; background:url(./foshan/phone_background_white.png) center center no-repeat; background-size:100% auto; height:35px;padding:11px 0px;color:#1d65d4; font-size:20px; font-weight:bold;">
                    400-850-0074
                </p>
                <p class="go_btn" style="float: right; margin-top:31px; width: 48%;">
                    <a href="javascript:void(0);" onclick="open_chat()"style="">点我立即咨询</a>
                </p>
            </div>
            <p style="clear: left; margin-top:22px; margin-bottom:36px; font-size:14px;">更多广东公司注册设立登记等，广东省工商局最新政策免费咨询中</p>
        </div>
    </div>
    <div class="pure-u-1 r_3">
        <div class="wrapper">
            <h2>广东公司注册 真正极简 快捷流程</h2>
            <p style="margin-top:12px; font-size:18px; color:#909090">综合化管理 只需三步 完成广东公司注册</p>
            <p style="margin-top:70px;" ><img src="./foshan/three_image.png" width="448" height="145" alt="" style="margin: 0 auto;"></p>
            <ul class="step_line">
                <li class="step">
                    <div class="setp_text">
                        <p>1-2工作日</p>
                ...
                <li class="line" style="width:250px"></li>
                <li class="step">
                    <div class="setp_text">
                        <p>3-5工作日</p>
                        <p>提交文件</p>
    ...
    <div class="pure-u-1 r_7">
        <div class="wrapper">
            <h2>广东开公司创业 一站式服务全程办理</h2>
            <ul>
                <li><div><img src="./foshan/pc6.png"></div><p>广东代办营业执照：企业或组织合法经营权的凭证</p></li>
                <li><div><img src="./foshan/pc2.png"></div><p>广东代办银行开户：开设日常使用的基本对公银行账户</p></li>
                <li><div><img src="./foshan/pc4.png"></div><p>广东代办税控发票：申办税控器，参加税控使用培训，核定申请发票</p></li>
                <li><div><img src="./foshan/pc1.png"></div><p>广东代理税务记账：完成广东公司注册，需先办理税务报道；成立后第一个月起，每月记账报税</p></li>
                <li><div><img src="./foshan/pc3.png"></div><p>广东社保开户：《社会保险法规定》，自成立之日起三十日内申请办理社会保险登记</p></li>
                <li><div><img src="./foshan/pc5.png"></div><p>广东商标注册：商标是企业的无形资产</p></li>
            </ul>
        </div>
    </div>
    <div class="pure-u-1 r_4">
        <div class="wrapper">
            <h2>选择我们 一劳永逸</h2>
            <p style="margin-top:12px; font-size:24px; color:#909090">省钱/省心/省时/省事</p>
        </div>
        <div class="pure-g" style="margin-top:60px">
            <div class="pure-u-1-2" style="background:url(./foshan/woman_blue.jpg) #1d65d4 right center no-repeat; height:399px">
                <dl class="leftT">
                    <dt>我们广东代办公司</dt>
                    <dd>
                        <p>告别繁琐工序及时间耗费</p>
        ...
        <table>
            <tbody><tr>
                <td valign="middle" class="td1">只收政府规定的费用，免广东工商代理注册公司服务费 <img src="./foshan/yes.png" width="21" height="21" alt="" class="l"></td>
            ...
            <tr>
                <td valign="middle" class="td1">全程广东代办公司注册，可提供广东公司注册地址 <img src="./foshan/yes.png" width="21" height="21" alt="" class="l"></td>
                <td valign="middle" class="td2"><div class="c_m">省心</div></td>
                <td valign="middle" class="td3"><img src="./foshan/no.png" width="21" height="21" alt="" class="r">需要找广东公司注册地址，再跑广东工商注册流程</td>
            </tr>
            <tr>
                <td valign="middle" class="td1"> 精通广东工商注册公司流程，最快只需3天 <img src="./foshan/yes.png" width="21" height="21" alt="" class="l"></td>
                <td valign="middle" class="td2"><div class="c_m">省时</div></td>
                <td valign="middle" class="td3"><img src="./foshan/no.png" width="21" height="21" alt="" class="r">自己办理不熟悉广东工商注册流程，可能需要1个月时间</td>
            </tr>
            <tr>
                <td valign="middle" class="td1">广东注册公司是复杂的过程，专业运营团队，简单快速 <img src="./foshan/yes.png" width="21" height="21" alt="" class="l"></td>
                <td valign="middle" class="td2"><div class="c_m">省事</div></td>
                <td valign="middle" class="td3"><img src="./foshan/no.png" width="21" height="21" alt="" class="r">流程复杂而繁琐，需跑广东省工商局/税务局/银行等</td>
            </tr>
            </tbody></table>
...
{{--            </tbody></table>--}}
    ...
    <div class="pure-u-1 r_6">
        <div class="wrapper">
            <h2>我们的优势</h2>
            <p style="margin-top:12px; font-size:16px; color:#909090">实力说明一切</p>
            <table>
                <tbody>
                <tr>
                    <th width="120">项目</th>
                    ...
                    <th width="400">大好时光（广东）企业管理有限公司</th>
                    <th width="400">其他广东代理注册公司</th>
                </tr>
                <tr>
                    <td rowspan="2" class="r_6_b"><b>服务速度</b></td>
                    <td class="name">广东注册公司名称查询速度</td>
                    <td><div class="cz"></div>3个小时内</td>
                    <td><div class="cn"></div>无法保证时效</td>
                </tr>
                <tr>
                    <td class="name">广东省工商局核名申请</td>
            ...
            <p style="margin-top:72px; font-size:24px; font-family:&#39;Microsoft YaHei&#39;">广东注册公司 只需一个电话</p>
            <p style="margin-top:10px; margin-bottom:72px; background:url(./foshan/phone_bakground_blue.png) center center no-repeat; height:30px;padding:11px 0px;color:#fff; font-size:27px; font-weight:bold;">400-850-0074</p>
        </div>
    </div>
    <div class="pure-u-1 r_9">
        <div class="wrapper">
            <h2>选择很重要 0元广东代办注册公司服务费</h2>
            <p>全程专属人员服务，广东代办公司注册，广东代理记账等，小微企业一站式服务平台</p>
            <div style="text-align: center; width: 1200px; margin: auto;">
                <p class="go_btn" style="float: right; margin-top:31px; width: 400px;"><a href="javascript:void(0);" onclick="open_chat()"style="">点我立即咨询</a></p>
            </div>
        </div>
    </div>
{{--    start--}}
                        ...
                        <td valign="middle" class="th2 th">
                            <ul>
                                <li>
                                    ...
                                    <div class="q"><h3>广东注册公司需要准备哪些资料？<a class="datetime">2019-04-18</a></h3></div>
                                </li>
                                <li class="b_line">
                                    <div class="icon_a"></div>
                                    <div class="a">广东公司注册地址租赁合同；广东注册公司名称；公司股东信息；股东投资比例；广东公司注册资金；公司经营范围。</div>
                                </li>
                            </ul>
                        </td>
                    ...
                    <tr>
                        <td valign="middle" class="th2 th">
                            <ul>
                                <li>
                                    <div class="icon_q"></div>
                                    <div class="q"><h3>广东工商注册登记改革利好政策有哪些？<a class="datetime">2019-04-18</a></h3></div>
                                </li>
                                <li class="b_line">
                                    <div class="icon_a"></div>
                                    <div class="a">广东省工商局简化广东公司注册登记流程；广东公司注册资金实行认缴制。 </div>
                                </li>
                            </ul>
                        </td>
                        <td valign="middle" class="th2 th">
...
{{--                        </ul>--}}
            <p style="margin-top: 50px;">Copyright &#169; &nbsp;<a href="http://www.beian.miit.gov.cn" >大好时光（广东）企业管理有限公司 粤ICP备18159108号</a><a> 广东省禅城区雾岗路河南工业区91号三楼317 联系方式： 13825566194 </a></p>
    ...
    <div class="pure-u-1 r_8">
        <div class="wrapper">
            ...
            <ul>
                <li>
                    <div class="icon_q"></div>
                    <div class="q"><h3>广东注册公司需要准备哪些资料？</h3></div>
                </li>
                <li class="b_line">
                    <div class="icon_a"></div>
                    <div class="a">广东公司注册地址租赁合同；广东注册公司名称；公司股东信息；股东投资比例；广东公司注册资金；公司经营范围。</div>
                ...
                <li>
                    <div class="icon_q"></div>
                    <div class="q"><h3>广东公司注册下来有哪些资料？</h3></div>
                </li>
                <li class="b_line">
                    <div class="icon_a"></div>
                ...
                <li>
                    <div class="icon_q"></div>
                    <div class="q"><h3>广东工商注册登记改革利好政策有哪些？</h3></div>
                </li>
                <li class="b_line">
                    <div class="icon_a"></div>
                    <div class="a">广东省工商局简化广东公司注册登记流程；广东公司注册资金实行认缴制。 </div>
...
<div class="bott">
    <div class="bott-int wid">
        ...
        <div class="zx-midd">
            ...
            <p>Copyright &#169; &nbsp;<a href="http://www.beian.miit.gov.cn" >大好时光（广东）企业管理有限公司 粤ICP备18159108号</a> </p>
        </div>
{{--        <div class="zx-rig">--}}
{{--            <p>400-850-0074</p>--}}
{{--            <img src="./foshan/txet.png">--}}
{{--        </div>--}}
    </div>
</div>
